...
public class HomeAdmin {
    ...
    public HomeAdmin(boolean visible) {
        ...
        JButton button3 = createVerticalButton("Menu Principal");
        ...
        button4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Fechar a tela atual
                frame.dispose();
                new GerenciarFuncionarios(true);
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                HomeAdmin homeAdmin = new HomeAdmin(true);
                homeAdmin.show();
            }
        });
    }
